...
* initBitmapData(fontAtlas_BMD:BitmapData,fontXML:XML,dynamicAtlas:DynamicAtlas=null)
* 
* 
After creating a BitmapFontEx, you must register it with Compositor like so:

`var arial_BF:BitmapFontEx = new BitmapFontEx("abcdefghijklmnopqrstuvwxyz");
